//
//  CategoryStoreDataManager5.swift
...
class CategoryStoreDataManager5 {
    func getCategoryStore5(delegate: PizzaViewController) {
        
        let url = "https://rc1-hardy.shop/stores/categories?categoryIdx=6"
