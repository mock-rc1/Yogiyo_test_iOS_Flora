//
//  CategoryStoreDataManager15.swift
...
class CategoryStoreDataManager15 {
    func getCategoryStore15(delegate: HealthViewController) {
        
        let url = "https://rc1-hardy.shop/stores/categories?categoryIdx=16"
