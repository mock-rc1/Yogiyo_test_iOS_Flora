//
//  CategoryStoreDataManager3.swift
...
class CategoryStoreDataManager3 {
    func getCategoryStore3(delegate: KoreaFoodViewController) {
        
        let url = "https://rc1-hardy.shop/stores/categories?categoryIdx=4"
