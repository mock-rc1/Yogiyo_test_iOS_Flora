//
//  CategoryStoreDataManager4.swift
...
class CategoryStoreDataManager4 {
    func getCategoryStore4(delegate: BurgerViewController) {
        
        let url = "https://rc1-hardy.shop/stores/categories?categoryIdx=5"
