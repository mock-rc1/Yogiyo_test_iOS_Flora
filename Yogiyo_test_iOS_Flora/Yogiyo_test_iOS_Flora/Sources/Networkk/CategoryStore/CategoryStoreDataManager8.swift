//
//  CategoryStoreDataManager8.swift
...
class CategoryStoreDataManager8 {
    func getCategoryStore8(delegate: BunsikViewController) {
        
        let url = "https://rc1-hardy.shop/stores/categories?categoryIdx=9"
