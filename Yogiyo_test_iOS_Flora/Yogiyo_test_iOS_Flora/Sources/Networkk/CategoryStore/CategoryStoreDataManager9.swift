//
//  CategoryStoreDataManager9.swift
...
class CategoryStoreDataManager9 {
    func getCategoryStore9(delegate: OnePersonViewController) {
        
        let url = "https://rc1-hardy.shop/stores/categories?categoryIdx=10"
