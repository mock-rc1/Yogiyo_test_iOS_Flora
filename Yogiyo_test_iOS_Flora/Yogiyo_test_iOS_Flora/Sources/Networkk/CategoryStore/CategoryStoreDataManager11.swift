//
//  CategoryStoreDataManager11.swift
...
class CategoryStoreDataManager11 {
    func getCategoryStore11(delegate: NightViewController) {
        
        let url = "https://rc1-hardy.shop/stores/categories?categoryIdx=12"
