//
//  CategoryStoreDataManager6.swift
...
class CategoryStoreDataManager6 {
    func getCategoryStore6(delegate: TangViewController) {
        
        let url = "https://rc1-hardy.shop/stores/categories?categoryIdx=7"
