//
//  CategoryStoreDataManager2.swift
...
class CategoryStoreDataManager2 {
    func getCategoryStore2(delegate: ChickenViewController) {
        
        let url = "https://rc1-hardy.shop/stores/categories?categoryIdx=3"
