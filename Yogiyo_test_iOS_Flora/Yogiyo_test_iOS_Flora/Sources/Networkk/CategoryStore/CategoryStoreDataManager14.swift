//
//  CategoryStoreDataManager14.swift
...
class CategoryStoreDataManager14 {
    func getCategoryStore14(delegate: MartViewController) {
        
        let url = "https://rc1-hardy.shop/stores/categories?categoryIdx=15"
