//
//  CategoryStoreDataManager7.swift
...
class CategoryStoreDataManager7 {
    func getCategoryStore7(delegate: CafeViewController) {
        
        let url = "https://rc1-hardy.shop/stores/categories?categoryIdx=8"
