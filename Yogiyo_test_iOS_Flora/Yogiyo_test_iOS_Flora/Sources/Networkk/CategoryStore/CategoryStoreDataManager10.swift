//
//  CategoryStoreDataManager10.swift
...
class CategoryStoreDataManager10 {
    func getCategoryStore10(delegate: JapaneseFoodViewController) {
        
        let url = "https://rc1-hardy.shop/stores/categories?categoryIdx=11"
