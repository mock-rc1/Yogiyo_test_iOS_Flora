//
//  CategoryStoreDataManager17.swift
...
class CategoryStoreDataManager17 {
    func getCategoryStore17(delegate: ChineseFoodViewController) {
        
        let url = "https://rc1-hardy.shop/stores/categories?categoryIdx=17"
