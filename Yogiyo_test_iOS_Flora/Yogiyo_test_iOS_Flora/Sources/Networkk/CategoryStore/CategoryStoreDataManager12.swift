//
//  CategoryStoreDataManager12.swift
...
class CategoryStoreDataManager12 {
    func getCategoryStore12(delegate: BossamViewController) {
        
        let url = "https://rc1-hardy.shop/stores/categories?categoryIdx=13"
