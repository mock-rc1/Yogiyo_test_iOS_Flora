...
class FranchiseViewController: UIViewController, IndicatorInfoProvider {
    
    lazy var dataManager: CategoryStoreDataManager13 = CategoryStoreDataManager13()
   ...
   var categoryStore : [CategoryStoreResult] = []
    ...
    override func viewDidLoad() {
        ...
        dataManager.getCategoryStore13(delegate: self)
    ...
    func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo {
        return IndicatorInfo(title: "프렌차이즈")
    }
...
extension FranchiseViewController: UITableViewDelegate, UITableViewDataSource {
