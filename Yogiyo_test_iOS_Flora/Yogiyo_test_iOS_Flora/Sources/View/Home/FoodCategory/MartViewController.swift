...
class MartViewController: UIViewController, IndicatorInfoProvider {
    
    lazy var dataManager: CategoryStoreDataManager14 = CategoryStoreDataManager14()
   ...
   var categoryStore : [CategoryStoreResult] = []
    ...
    override func viewDidLoad() {
        ...
        dataManager.getCategoryStore14(delegate: self)
    }
    ...
    func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo {
        return IndicatorInfo(title: "편의점/마트")
    }
...
extension MartViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            cell.foodImageView.sd_setImage(with: URL(string: store.storeLogoURL ?? "https://yogiyoserver.s3.ap-northeast-2.amazonaws.com/icon/storeIcon/IMG_7739.jpg"))
