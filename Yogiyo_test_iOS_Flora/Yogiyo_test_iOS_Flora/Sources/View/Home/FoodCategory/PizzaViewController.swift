...
class PizzaViewController: UIViewController, IndicatorInfoProvider {
    ...
    lazy var dataManager: CategoryStoreDataManager5 = CategoryStoreDataManager5()
   ...
   var categoryStore : [CategoryStoreResult] = []
    ...
    var sections = [1]
        ...
        override func viewDidLoad() {
            ...
            self.PizzaTableView.register(MyStoreTableViewCell.nib(), forCellReuseIdentifier: MyStoreTableViewCell.identifier)
            
            PizzaTableView.separatorColor = UIColor.clear
            
                    //AllTableView.tableFooterView = UIView(frame: .zero)
            PizzaTableView.sectionFooterHeight = 0
            
            dataManager.getCategoryStore5(delegate: self)
        }
        ...
        func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo {
            return IndicatorInfo(title: "피자/양식")
        }
    ...
    func setStyle() {
        // 테이블 뷰 경계션 없애기
        PizzaTableView.separatorInset = UIEdgeInsets(top: 0, left: 0, bottom: 0, right: .greatestFiniteMagnitude)
    }
