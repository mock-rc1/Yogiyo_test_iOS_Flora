...
class PetViewController: UIViewController, IndicatorInfoProvider {
    
    lazy var dataManager: CategoryStoreDataManager16 = CategoryStoreDataManager16()
   ...
   var categoryStore : [CategoryStoreResult] = []
    ...
    var sections = [1]
        ...
        dataManager.getCategoryStore16(delegate: self)
        }
        ...
        func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo {
            return IndicatorInfo(title: "반려동물용품")
        }
