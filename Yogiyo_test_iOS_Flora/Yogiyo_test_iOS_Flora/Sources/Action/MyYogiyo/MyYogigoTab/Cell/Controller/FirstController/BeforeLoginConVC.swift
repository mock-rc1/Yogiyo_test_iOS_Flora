...
class BeforeLoginConVC: UIViewController {
    ...
    @IBAction func loginBtnTap(_ sender: UIButton) {
        ...
        let storyboardVC = UIStoryboard(name: "MyYogiyoStoryboard", bundle: Bundle(for: SocialLoginViewController.self)).instantiateViewController(withIdentifier: "SocialLoginViewController") as! SocialLoginViewController
